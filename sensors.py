# sys.path.insert(0,'/home/pi/Code/Adafruit_Python_DHT')
...
class dht22:
    ...
    def read(self):
        humidity, temperature = self.read_retry(self.sensor,self.pin )
...
# def tsl2561():
#     SMBus(1).write_byte_data(0x39, 0x00 | 0x80, 0x03)
#     SMBus(1).write_byte_data(0x39, 0x01 | 0x80, 0x02)
#     sleep(0.5)
#     data = SMBus(1).read_i2c_block_data(0x39, 0x0C | 0x80, 2)
#     data1 = SMBus(1).read_i2c_block_data(0x39, 0x0E | 0x80, 2)
...
class sen0193:
    ...
    def __init__(self,pin):
        ...
        self.reader =self.adc.channel(pin=pin, attn=machine.ADC.ATTN_11DB)
...
class bme280:
    def __init__(self):
        ...
        self.bus = smbus2.SMBus(1)  # Rev 2 Pi, Pi 2 & Pi 3 uses bus 1
